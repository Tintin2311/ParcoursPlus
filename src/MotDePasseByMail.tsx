...
export default function MotDePasseByMail({
  setPage,
  ...
  const erreurNouveauMotDePasse = useMemo(() => {
    ...
    return "";
  }, [nouveauMotDePasse, missingRules]);
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      ...
      if (!hasSession) {
        setErrorFeedback(
          "La session de récupération est introuvable. Veuillez recliquer sur le lien reçu par email."
        );
        return;
      }
      ...
      if (error) {
        setErrorFeedback(
          error.message || "La modification du mot de passe a échoué."
        );
        return;
      }
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>
            Choisissez un nouveau mot de passe sécurisé pour finaliser la récupération de votre compte.
          </Text>
          ...
          <View style={styles.fieldBlock}>
            ...
            <View style={styles.rulesBox}>
              <RuleItem ok={passwordChecks.minLength} label="Au moins 8 caractères" />
              <RuleItem ok={passwordChecks.uppercase} label="Au moins une majuscule" />
              <RuleItem ok={passwordChecks.lowercase} label="Au moins une minuscule" />
              <RuleItem ok={passwordChecks.digit} label="Au moins un chiffre" />
              <RuleItem ok={passwordChecks.special} label="Au moins un caractère spécial" />
            </View>
          </View>
